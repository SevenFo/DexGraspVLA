...
class DexGraspVLAPlanner:
                ...
                },
                {
                    ...
                    "content": [
                        ...
                        },
                        {
                            "type": "image_url",
                            "image_url": {
                                "url": vl_inputs["images"]["initial_head_image"]
                            },
                        },
                        {
                            "type": "text",
                            "text": "The current image (after the latest action) is:",
                        },
                        {
                            "type": "image_url",
                            "image_url": {
                                "url": vl_inputs["images"]["current_head_image"]
                            },
                        },
                        {
                            "type": "text",
            ...
            messages = [
                ...
                },
                {
                    ...
                    "content": [
                        {
                            "type": "text",
                            "text": "You are a robotic vision assistant. Your task is to locate the object described below in the given image:",
                        },
                        {
                            "type": "image_url",
                            "image_url": {
            ...
            messages = [
                ...
                },
                {
                    ...
                    "content": [
                        {
                            "type": "text",
                            "text": "I will show you two images. The top-down view from the head camera is:",
                        },
                        {
                            "type": "image_url",
                            "image_url": {
                        ...
                        {
                            "type": "text",
                            "text": "The close-up view from the wrist camera is:",
                        },
                        {
                            "type": "image_url",
                            "image_url": {
                                "url": vl_inputs["images"]["current_wrist_image"]
                            },
                        },
                        {
                            "type": "text",
    ...
    def process_message_for_logging(self, messages):
        ...
        messages_for_logging = json.dumps(
            processed_messages, indent=2, ensure_ascii=False
        )
    ...
    def save_image(self, image_url, task_name, image_type):
        ...
        image_path = os.path.join(
            self.image_dir, f"{timestamp}_planner_request_{task_name}_{image_type}.png"
        )
        plt.imsave(image_path, image)
        self.log(
            f"The {image_type} saved when planner requests {task_name}.",
            message_type="info",
        )
