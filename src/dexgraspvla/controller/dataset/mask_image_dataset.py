...
from dexgraspvla.controller.common.streaming_replay_buffer import (
    StreamingReplayBuffer,
)
from dexgraspvla.controller.common.sampler import (
    SequenceSampler,
    get_val_mask,
    downsample_mask,
)
...
class MaskImageDataset(BaseImageDataset):
    ...
    def _process_mask_image_batch(self, images):
        ...
        rgb = F.interpolate(
            rgb / 255.0, size=self.image_size, mode="bilinear", align_corners=False
        )
